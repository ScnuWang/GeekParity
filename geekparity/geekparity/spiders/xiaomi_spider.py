...
class XiaomiSpider(scrapy.Spider):
            ...
            if categoryitem['item_type'] == 6:
                ...
                if categoryitem['data'] is not None:
                    for project_data in categoryitem['data']:
                        ...
                        request = FormRequest(url='https://youpin.mi.com/app/shop/pipe', method='POST',body=encode_body, callback=self.parse_project)
    ...
    def parse_project(self, response):
        ...
        yield FormRequest(url='https://youpin.mi.com/app/shopv3/pipe', method='POST', body=encode_body,callback=self.parse_comment)

        project['project_score'] = ''

    def parse_comment(self,response):
        print(json.loads(response.text)['result']['overView']['data']['positive_rate'])